...
function getCurrentWeather (city) {
  return axios.get('api.openweathermap.org/data/2.5/weather?q=' + city + '&type=accurate' + param);
}

function getForecast (city) {
  return axios.get('api.openweathermap.org/data/2.5/forecast/daily?q=' + city + '&type=accurate=' + param + '&cnt=5')
}
